...
def try_restore_latest_checkpoints(model_dir, models, map_func=None):
    ...
    for name, model in name_to_model.items():
        ...
        print("======================================================================= last ckpt is", latest_ckpt )
...
def transfer(weights):
    ...
    torch.save(state_dict, "1.tckpt", _use_new_zipfile_serialization=False)
if __name__ == "__main__":
    weights = "/data/kd_alg/second.pytorch/torchplus/voxelnet-52920.tckpt"
    transfer(weights)
