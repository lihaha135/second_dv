import numpy as np
from .eval_util import calculate_iou_partly
from .eval_util import prepare_data
from .eval_util import compute_statistics_jit
# from second.utils.eval import compute_statistics_jit
# from second.utils.eval import calculate_iou_partly
...
def get_wjdata_eval_result(gt_annos, dt_annos, classes):
    metric = 2
    gt_num = len(gt_annos)
    ...
    print(f"Wjdata Evaluation Score: {final_score}")
